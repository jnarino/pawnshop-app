...
export async function createApp() {
  ...
  const updatePoliceHoldUseCase = new UpdatePoliceHoldUseCase(holdUnitOfWork);
  ...
  const getDefaultedLayawaysUseCase = new GetDefaultedLayawaysUseCase(layawayRepo);
  ...
  const pullLayawayUseCase = new PullLayawayUseCase(layawayUnitOfWork);
  const unpullLayawayUseCase = new UnpullLayawayUseCase(layawayUnitOfWork);
  ...
  const policeController = new PoliceController(
    listPoliceHoldUseCase,
    createPoliceHoldUseCase,
    updatePoliceHoldUseCase
  );
