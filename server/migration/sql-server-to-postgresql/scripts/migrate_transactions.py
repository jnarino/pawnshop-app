    ...
    try:
        ...
        for row in tqdm(rows):
            try:
                ...
                change = float(row['TENDCHANGE'] or 0)
                note = "" # NOTE column does not exist in Acct
