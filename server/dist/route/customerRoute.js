...
const container_1 = require("../container"); // <— where your factory was wired
const router = (0, express_1.Router)();
// GET /api/customer/        → list all customers
router.get('/', container_1.customerController.getAll);
// GET /api/customer/:id     → get one customer by ID
router.get('/:id', container_1.customerController.getById);
...
router.delete('/:id', container_1.customerController.delete);
