...
import { reportsApi, ItemsInPawnsReportData } from "@/app/core/api/reportsApi";
import { Printer, Download, X, Loader2 } from "lucide-react";
import { generateItemsInPawnsPdf } from "./generateItemsInPawnsPdf";
...
export const ItemsInPawnsReportPage = () => {
    ...
    const submit = async () => {
        ...
        try {
            ...
            const result = await reportsApi.pawnActiveReport(params);
            ...
            const pdfBlob = await generateItemsInPawnsPdf(result, { from: '', to: '' }, { exclude: excludeFirearms });
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-100px)] pt-4 space-y-4">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-extrabold">Items in Pawns Report</h1>
