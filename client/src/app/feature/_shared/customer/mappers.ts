...
export function dtoToRecord(c?: CustomerDto | null): CustomerRecord {
  ...
  return {
    ...
    hairColor: (c as any).hairColorId ?? c.hairColor ?? null,
    eyeColor: (c as any).eyeColorId ?? c.eyeColor ?? null,
    race: c.race ?? null,
    sex: c.sex ?? null,
    marks: c.marks ?? null,
...
export function recordToDto(r: CustomerRecord, id?: string): CustomerDto {
  return {
    ...
    hairColorId: r.hairColor ?? null,
    eyeColorId: r.eyeColor ?? null,
    race: r.race ?? null,
    sex: r.sex ?? null,
    marks: r.marks ?? null,
...
export function apiToRecordLoose(c: any): CustomerRecord {
  return {
    ...
    height: c.height ?? null,
    weight: c.weight ?? null,
    hairColor: c.hairColorId ?? c.hair_color_id ?? c.hairColor ?? c.hair_color ?? null,
    eyeColor: c.eyeColorId ?? c.eye_color_id ?? c.eyeColor ?? c.eye_color ?? null,
    race: c.race ?? null,
    sex: c.sex ?? null,
    marks: c.marks ?? null,
