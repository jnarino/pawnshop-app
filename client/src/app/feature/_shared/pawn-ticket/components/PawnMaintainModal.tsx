...
import { PawnTicketForm } from '.';

interface PawnMaintainModalProps {
...
export function PawnMaintainModal({ open, onClose }: PawnMaintainModalProps) {
